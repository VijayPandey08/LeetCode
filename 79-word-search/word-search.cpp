class Solution
{
    public:
    int m,n;
        vector<vector<int>> directions{{1,0},{-1,0},{0,1},{0,-1}}; // dorections vector pehle hi bana dia taake chaaro direction ke lie alag alaga call na krni pde
        bool find(vector<vector < char>> &board, int i, int j, int idx,  string &word)
        {
            ...
            for(auto &dir:directions){ // for loop laga ke chaaaro direction traverse kr li
                int new_i = i +dir[0];
                int new_j = j +dir[1];
